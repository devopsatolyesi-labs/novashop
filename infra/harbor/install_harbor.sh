...
if ! docker compose version &> /dev/null; then
    echo "⚠️ Docker Compose V2 eklentisi bulunamadı, apt ile kuruluyor..."
...
for line in lines:
    if line.startswith("hostname:"):
        out.append(f"hostname: ${LOCAL_IP}\n")
...
PYEOF
    ...
    sudo sed -i "s/hostname: reg.mydomain.com/hostname: ${LOCAL_IP}/" "${INSTALL_DIR}/harbor.yml"
...
echo "Web Arayüzü : http://${LOCAL_IP}:18082"
echo "Kullanıcı   : admin"
echo "Şifre       : Harbor12345"
echo ""
echo "Docker Login Testi:"
echo "  docker login ${LOCAL_IP}:18082 -u admin -p Harbor12345"
echo "======================================================================"
