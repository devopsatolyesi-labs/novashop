...
create_dataview "novashop-*" "NovaShop — Tüm Sistem Logları (K8s, Docker, Ubuntu)" "@timestamp"

# 2. Docker Konteyner Logları (Uygulamalar, Jenkins, GitLab vb.)
create_dataview "novashop-docker-*" "NovaShop — Docker Konteyner Logları" "@timestamp"

# 3. Kubernetes Pod Logları
create_dataview "novashop-k8s-*" "NovaShop — Kubernetes (Kind) Pod Logları" "@timestamp"

# 4. Ubuntu Host Sistem Logları
create_dataview "novashop-ubuntu-*" "NovaShop — Ubuntu Sunucu Syslog & Auth" "@timestamp"
